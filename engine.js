...
import { monitorIncomingAttacks, checkGuildLog } from './app_modules/GuildConflicts.js';
...
import { checkForPvPNotifications, handleLadderNotification, fetchAllPreviousPvPLadders } from './app_modules/Ladder.js';
import { checkForTitanNotifications } from './app_modules/Titans.js';
import { checkRelics } from './app_modules/Relics.js';
import { checkConflictsAndSwapGear, autoJoinAllGroups } from './app_modules/QoL.js';
...
export function initEngine() {
  ...
  try { checkForPvPNotifications(); } catch (e) { ERR('pvp', 'kickoff', e); }
  ...
  setInterval(() => { try { checkForPvPNotifications(); } catch (e) { ERR('pvp', 'interval', e); } }, 1000 * 60 * 2);
