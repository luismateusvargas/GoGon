...
``FS_USERNAME`` and ``FS_PASSWORD`` environment variables, then keeps the
...
LOGIN_URL = "https://www.fallensword.com/"
...
if __name__ == "__main__":
    if not USERNAME or not PASSWORD:
        raise SystemExit("FS_USERNAME and FS_PASSWORD must be set")
    main()
